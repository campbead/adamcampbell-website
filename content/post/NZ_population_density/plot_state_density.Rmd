...
I plan on going into detail on this a future blog plot, in the meantime I've made the [source code available for this calculation](https://github.com/campbead/Urbanization_NZ). 
...
- Lived density is a better way of computing population density when what you care about is how many people does the average person live near.  Which is probably the case for modeling disease spread.
