...
However this tweet is specific only to the example, I want to generalize the code for any Wikipedia table.

I'm going to show you to scrape any Wikipedia table using Firefox browser and R (of course), although I'm sure this could be adapted to other browsers.  
